...
public class AgroPlantationAppApplication {
	public static void main(String[] args) {
		 ...
		 * docker run --name mysql-standalone -e MYSQL_ROOT_PASSWORD=root -e
		 * MYSQL_DATABASE=agroplantationapp -e MYSQL_USER=dev -e MYSQL_PASSWORD=dev -p
		 * 3306:3306 -d mysql:8.1
		 * docker run -d -p 8080:8080 --name agro-plantation --link
		 * mysql-standalone:mysql
		 * 45c1aa341cf3b7d80d43c85adb182ec8f72f63976e289004077534ff32799e3f
		 * 
		 * 
		 * 
		 * 
